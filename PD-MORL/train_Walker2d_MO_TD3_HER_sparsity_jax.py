...
if __name__ == "__main__":
    ...
    actor_state = TrainState_actor.create(
        ...
        tx=optax.chain(optax.clip_by_global_norm(max_norm = 100.0), optax.adam(learning_rate=args.lr_actor)),
    )
    ...
    critic_state = TrainState_critic.create(
        ...
        tx=optax.chain(optax.clip_by_global_norm(max_norm = 100.0), optax.adam(learning_rate=args.lr_critic)),
    )
